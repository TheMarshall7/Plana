...
export default function Header() {
  const { addToast, unreadNotifications, markNotificationsRead } = useStore();

  return (
    <header className="flex justify-between items-center px-5 lg:px-8 pt-8 pb-4 lg:pb-6 animate-fade-in relative z-40">
